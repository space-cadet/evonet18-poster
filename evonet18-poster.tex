...
\title{Arrow of Time from \\ Spontaneous Symmetry Breaking in LQG} % Poster title

\author{Deepak Vaid} % Author(s)

\institute{Department of Physics, National Institute of Technology Karnataka (NITK), India} % Institution(s)
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{area_puncture}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{area_punctures}
\caption{Figure caption}
\end{figure}
...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[width=0.4\linewidth]{mpipks_logo.png} & \hfill & \includegraphics[width=0.4\linewidth]{nitk_logo.png}
\end{tabular}
\end{center}
